    ...
    <div className="w-full max-w-3xl mx-auto flex items-center justify-between">
      ...
      <Dialog.Root>
        <Dialog.Trigger>
          <button
            type="button"
            className="border border-cyan-500 font-semibold rounded-lg px-6 py-4 flex items-center gap-3 hover:border-cyan-900"
          >
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="absolute p-10 bg-gray-800 rounded-2xl w-full max-w-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <Dialog.Close className="absolute right-6 top-6 text-gray-400 hover:text-gray-200">
